...
* Added Pages Module integration - Entries will use their {page\_url} (where applicable) rather than the generated URL based on the extension settings \( [bug](http://expressionengine.com/forums/viewreply/473025/) \)
